...
function survstaLogo(idSuffix = "nav", isDark = false){
  return `<img alt="Survsta" src="assets/img/Designer.png" class="object-contain survsta-logo" style="width: 220px !important; min-width: 220px !important; height: auto !important; max-height: 70px !important; display: block;" />`;
}
...
<header class="header"><div class="wrap">
  <a href="index.html" class="brand flex items-center w-auto shrink-0" style="min-width: 220px;" aria-label="Survsta">${survstaLogo("nav")}</a>
...
<footer class="footer"><div class="wrap">
  <div class="fgrid">
    <div>
      <div class="brand flex items-center w-auto shrink-0" style="color:#fff; min-width: 220px;">${survstaLogo("foot")}</div>
