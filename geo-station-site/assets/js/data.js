...
var IMG = {
  office:      "assets/img/office-gis-team.jpg",
  gnssSite:    "assets/img/gnss-construction.jpg",
  teamTS:      "assets/img/team-total-station.jpg",
  gnssTablet:  "assets/img/gnss-tablet.jpg",
  tsField:     "assets/img/total-station-field.jpg",
  product:     "assets/img/instruments-product.jpg"
};
...
var PROVIDERS = [
  {id:1, slug:"elite-survey", name:"مكتب النخبة للمساحة", type:"مكتب مساحة", cat:"offices",
   ...
   ver:["ملف موثّق","نشاط موثّق"], featured:true, img:IMG.office, x:64, y:28,
  ...
  {id:2, slug:"delta-geomatics", name:"دلتا جيوماتكس", type:"شركة مساحة", cat:"companies",
   ...
   ver:["ملف موثّق","نشاط موثّق","معدات موثّقة"], featured:true, img:IMG.teamTS, x:36, y:50,
  ...
  {id:3, slug:"nile-instruments", name:"النيل لأجهزة المساحة", type:"مورد أجهزة", cat:"suppliers",
   ...
   ver:["ملف موثّق"], featured:false, img:IMG.product, x:43, y:42,
  ...
  {id:4, slug:"precision-cal", name:"مركز الدقة للمعايرة", type:"مركز معايرة", cat:"calibration",
   ...
   ver:["ملف موثّق","نشاط موثّق"], featured:false, img:IMG.gnssTablet, x:27, y:64,
  ...
  {id:5, slug:"geo-academy-eg", name:"جيو أكاديمي مصر", type:"مركز تدريب", cat:"training",
   ...
   ver:["ملف موثّق"], featured:false, img:IMG.tsField, x:72, y:20,
  ...
  {id:6, slug:"west-survey", name:"الغرب للخدمات المساحية", type:"مكتب مساحة", cat:"offices",
   ...
   ver:["ملف موثّق"], featured:false, img:IMG.gnssSite, x:55, y:38,
  ...
  {id:7, slug:"horizon-geo", name:"هورايزون جيو للمساحة", type:"شركة مساحة", cat:"companies",
   ...
   ver:["ملف موثّق","نشاط موثّق"], featured:false, img:IMG.gnssSite, x:22, y:56,
  ...
  {id:8, slug:"alex-instruments", name:"الإسكندرية للأجهزة الهندسية", type:"مورد أجهزة", cat:"suppliers",
   ...
   ver:["ملف موثّق","معدات موثّقة"], featured:false, img:IMG.product, x:68, y:34,
  ...
  {id:9, slug:"mizan-cal", name:"مركز الميزان للمعايرة والصيانة", type:"مركز معايرة", cat:"calibration",
   ...
   ver:["ملف موثّق"], featured:false, img:IMG.gnssTablet, x:47, y:47,
...
var EQUIPMENT = [
  {id:1, slug:"leica-ts16", title:"Leica TS16 Total Station", cat:"Total Station", brand:"Leica",
   ...
   cal:"سارية حتى 04/2026", avail:"متاح الآن", img:IMG.tsField, year:2021,
  ...
  {id:2, slug:"topcon-gt1200", title:"Topcon GT-1200 روبوتيك", cat:"Total Station", brand:"Topcon",
   ...
   cal:"شهادة مصنع", avail:"متاح", img:IMG.product, year:2025,
  ...
  {id:3, slug:"gnss-rtk-set", title:"طقم GNSS RTK — Stonex S900", cat:"GNSS / RTK", brand:"Stonex",
   ...
   cal:"غير مُدرجة", avail:"محجوز حتى 12/09", img:IMG.gnssTablet, year:2022,
  ...
  {id:4, slug:"faro-focus", title:"FARO Focus 3D ماسح ليزري", cat:"Laser Scanner", brand:"FARO",
   ...
   cal:"سارية حتى 01/2026", avail:"متاح الآن", img:IMG.teamTS, year:2020,
  ...
  {id:5, slug:"dji-m300", title:"DJI Matrice 300 RTK", cat:"Drone", brand:"DJI",
   ...
   cal:"غير مُدرجة", avail:"متاح الآن", img:IMG.gnssSite, year:2022,
  ...
  {id:7, slug:"trimble-r12i", title:"Trimble R12i GNSS", cat:"GNSS / RTK", brand:"Trimble",
   ...
   cal:"سارية حتى 07/2026", avail:"متاح الآن", img:IMG.gnssTablet, year:2023,
  ...
  {id:8, slug:"survey-tripod-kit", title:"حزمة حوامل وعواكس ومستلزمات", cat:"ملحقات وقطع غيار", brand:"Spectra",
   cond:"جديد", modes:["sale"], price:"حسب العرض", unit:"", gov:"القاهرة", pid:3,
   cal:"لا ينطبق", avail:"متاح", img:IMG.product, year:2025,
  ...
  {id:9, slug:"south-total-station", title:"South N7 Total Station", cat:"Total Station", brand:"South",
   ...
   cal:"منتهية — يلزم معايرة", avail:"متاح الآن", img:IMG.tsField, year:2019,
...
var SERVICES = [
  {slug:"topographic", t:"رفع مساحي طبوغرافي", cat:"مساحة أرضية", icon:"🗺️", n:24, img:IMG.tsField,
   d:"رفع تفصيلي للمناسيب ومعالم الموقع وإخراج خرائط كنتورية ومقاطع طولية وعرضية."},
  {slug:"laser-scan", t:"مسح ليزري ثلاثي الأبعاد", cat:"Reality Capture", icon:"🔦", n:9, img:IMG.teamTS,
   d:"توثيق المنشآت القائمة بسحابة نقاط عالية الكثافة وإنتاج مخططات As-Built ونماذج BIM."},
  {slug:"drone-survey", t:"مسح بالطائرات بدون طيار", cat:"Aerial Survey", icon:"🚁", n:12, img:IMG.gnssSite,
   d:"تغطية جوية سريعة للمساحات الكبيرة مع إنتاج أورثوفوتو ونماذج ارتفاع رقمية."},
  {slug:"subdivision", t:"تقسيم وفرز أراضي", cat:"مساحة قانونية", icon:"📋", n:18, img:IMG.office,
   d:"إعداد مخططات التقسيم والفرز وحساب المساحات وتجهيز المستندات المساحية المطلوبة."},
  {slug:"calibration-svc", t:"معايرة وصيانة الأجهزة", cat:"خدمات فنية", icon:"🛠️", n:7, img:IMG.gnssTablet,
   d:"فحص ومعايرة أجهزة المساحة وإصدار تقرير فني يوضح نتائج الضبط والدقة."},
  {slug:"gis-mapping", t:"إعداد خرائط وقواعد بيانات GIS", cat:"جيوماتكس", icon:"🧭", n:11, img:IMG.office,
   d:"بناء قواعد بيانات مكانية وتحليل شبكات ومرافق وإنتاج خرائط موضوعية."},
  {slug:"quantity", t:"حصر كميات وأعمال ترابية", cat:"دعم التنفيذ", icon:"📊", n:15, img:IMG.gnssSite,
   d:"حساب كميات الحفر والردم والمقارنة الدورية بين الوضع القائم والتصميم."},
  {slug:"monitoring", t:"مراقبة هبوط وحركة المنشآت", cat:"مراقبة دورية", icon:"📉", n:5, img:IMG.teamTS,
   d:"شبكات نقاط مرجعية وقياسات دورية لرصد الحركة والهبوط في المنشآت الحساسة."}
];

var COURSES = [
  {slug:"civil3d", t:"Civil 3D للمساحين", lvl:"متوسط", hours:"18 ساعة", center:"جيو أكاديمي مصر", img:IMG.office,
   d:"إنشاء السطوح والمحاور والمقاطع وحساب الكميات على مشروع طريق كامل من البداية للتسليم.", price:"3,500 جنيه"},
  {slug:"gnss-field", t:"تشغيل GNSS RTK ميدانيًا", lvl:"مبتدئ", hours:"12 ساعة", center:"جيو أكاديمي مصر", img:IMG.gnssSite,
   d:"ضبط Base وRover، الاتصال بشبكات التصحيح، الرفع والتوقيع، ومعالجة الأخطاء الشائعة.", price:"2,200 جنيه"},
  {slug:"ts-processing", t:"معالجة بيانات Total Station", lvl:"متوسط", hours:"10 ساعات", center:"دلتا جيوماتكس", img:IMG.tsField,
   d:"من التحميل الخام إلى الرسم النهائي: التصحيحات، الإغلاق، وضبط الشبكات.", price:"1,800 جنيه"},
  {slug:"qgis-basics", t:"أساسيات GIS باستخدام QGIS", lvl:"مبتدئ", hours:"15 ساعة", center:"جيو أكاديمي مصر", img:IMG.office,
   d:"بناء طبقات مكانية، الترميز، التحليل المكاني، وإخراج خرائط احترافية.", price:"2,000 جنيه"},
  {slug:"drone-mapping", t:"المسح الجوي ومعالجة الصور", lvl:"متقدم", hours:"20 ساعة", center:"دلتا جيوماتكس", img:IMG.gnssSite,
   d:"تخطيط الطلعات، نقاط التحكم الأرضية، ومعالجة سحابة النقاط والأورثوفوتو.", price:"4,800 جنيه"},
  {slug:"survey-law", t:"المساحة القانونية والتقسيم", lvl:"متوسط", hours:"14 ساعة", center:"جيو أكاديمي مصر", img:IMG.teamTS,
