        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
              ...
              <a
                href="https://wa.me/201033134413?text=%D8%A5%D8%A8%D9%84%D8%A7%D8%BA%20%D8%B9%D9%86%20%D8%A8%D9%8A%D8%A7%D9%86%D8%A7%D8%AA%20%D8%AE%D8%A7%D8%B7%D8%A6%D8%A9%20%D9%81%D9%8A%20Survsta"
                target="_blank"
                rel="noreferrer"
                className="inline-block px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-800 text-xs font-bold rounded-lg transition"
              >
                إرسال بلاغ فوري
              </a>
            </div>
